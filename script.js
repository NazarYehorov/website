...
class Calculator extends React.Component {
    ...
    handleNumbers(e) {
        if (!this.state.currentVal.includes("Limit")) {
            ...
            t.length > 19 ? this.maxDigitWarning() : r ? this.setState({
                currentVal: s,
                formula: "0" !== s ? s : ""
            }) : this.setState({
    ...
    handleDecimal() {
        ...
        this.state.currentVal.length > 19 ? this.maxDigitWarning() : endsWithOperator.test(this.state.formula) || "0" === this.state.currentVal && "" === this.state.formula ? this.setState({
            currentVal: "0.",
